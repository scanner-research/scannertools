...
class ImageDecoderKernelGPU : public Kernel {
 public:
  ...
  void execute(const BatchedElements& input_columns,
    ...
    ImageDecoderArgs_ImageType image_type = args_.image_type();
