...
#ifdef HAVE_CUDA
#include "caffe_input_transformer_gpu.h"
#endif
#include "caffe_input_transformer_cpu.h"
...
class CaffeInputKernel : public BatchedKernel, public VideoKernel {
 ...
 protected:
  void set_halide_buf(halide_buffer_t& halide_buf, u8* buf, size_t size);
  void unset_halide_buf(halide_buffer_t& halide_buf);
