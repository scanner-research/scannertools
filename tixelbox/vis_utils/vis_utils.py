# Mostly taken from
# https://github.com/tensorflow/models/blob/1f34fc/research/object_detection/utils/visualization_utils.py
# https://github.com/tensorflow/models/blob/1f34fc/research/object_detection/utils/label_map_util.py
#
# ==============================================================================
...
STANDARD_COLORS = [
    'AliceBlue', 'Chartreuse', 'Aqua', 'Aquamarine', 'Azure', 'Beige', 'Bisque', 'BlanchedAlmond',
    ...
    'NavajoWhite', 'OldLace', 'Olive', 'OliveDrab', 'Orange', 'OrangeRed', 'Orchid',
    'PaleGoldenRod', 'PaleGreen', 'PaleTurquoise', 'PaleVioletRed', 'PapayaWhip', 'PeachPuff',
    'Peru', 'Pink', 'Plum', 'PowderBlue', 'Purple', 'Red', 'RosyBrown', 'RoyalBlue', 'SaddleBrown',
    'Green', 'SandyBrown', 'SeaGreen', 'SeaShell', 'Sienna', 'Silver', 'SkyBlue', 'SlateBlue',
    'SlateGray', 'SlateGrey', 'Snow', 'SpringGreen', 'SteelBlue', 'GreenYellow', 'Teal', 'Thistle',
...
def parse_labelmap(path):
  ...
  Args:
    path: file path to the .pbtxt file
...
def draw_bounding_boxes_on_image(image, boxes, color='red', thickness=4, display_str_list_list=()):
  ...
  """
    ...
    for i in range(boxes_shape[0]):
        ...
        draw_bounding_box_on_image(image, boxes[i, 0], boxes[i, 1], boxes[i, 2], boxes[i, 3], color,
...
def draw_bounding_boxes_on_image_tensors(images,
  ...
  """
    ...
    def draw_boxes(image_boxes_classes_scores):
        ...
        image_with_boxes = tf.py_func(visualize_boxes_fn, [image, boxes, classes, scores], tf.uint8)
...
def add_cdf_image_summary(values, name):
  ...
  """
    ...
    def cdf_plot(values):
        ...
        image = np.fromstring(fig.canvas.tostring_rgb(), dtype='uint8').reshape(1, height, width, 3)
        return image
